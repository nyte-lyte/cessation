# Cessation — Claude Context

Full project memory is in the `memory/` directory. Read `memory/MEMORY.md` first — it is the index. Follow links to topic files as needed.
